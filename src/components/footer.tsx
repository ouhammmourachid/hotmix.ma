        ...
        <div className="grid grid-cols-1 items-start md:grid-cols-2 lg:grid-cols-3 gap-12 pb-7 lg:mx-20 mx-4">          {/* About Section */}
          <div className="space-y-6">
            ...
            <div className="flex gap-4">
              ...
              <a href="https://www.instagram.com/missjannatmaroc" className={styles.social_media + ' hover:text-pink-500 hover:border-pink-500'}>
                <Instagram className="w-5 h-5" />
              </a>
              <a href="#" className={styles.social_media + ' hover:text-red-500 hover:border-red-500'}>
                <Youtube className="w-5 h-5" />
              </a>
              <a href="https://www.tiktok.com/@missjannatmaroc" className={styles.social_media + ' hover:text-red-500 hover:border-red-500'}>
